...
Frontend:
- combine receipt scanner and shelf camera into one tab on the front-end (user should be able to toggle which they use, which will determine which processing happens under the hood)
